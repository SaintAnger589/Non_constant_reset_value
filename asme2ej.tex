...
Since the value change in the single bit can be 1 or 0, reset_val can be combined with rst_n in the following manner
...
This can be explained as follows in the truth table
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% begin table   %%%%%%%%%%%%%%%%%%%%%%%%%%
\caption{Truth table for the single bit non constant reset value}
\begin{center}
